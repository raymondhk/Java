package com.project.Guilds.services;
...
import com.project.Guilds.repositories.GuildRepository;
import com.project.Guilds.repositories.RingRepository;
import com.project.Guilds.repositories.UserRepository;
...
public class UserService {
	...
	public List<User> findAllUsersForGuild() {
		...
		for(User user : users) {
			...
			int days = today.compareTo(createdAt);
			user.setAge(days);
			uRepository.save(user);
		}
		return users;
